...
exports.dateAttribute = function (attr, now) {
    return {
        ...
        set: function (value) {
            if (!value) return;
            helpers.setAttribute(this.xml, attr, value.toISOString());
        }
    };
};
...
exports.dateSub = function (NS, sub, now) {
    return {
        ...
        set: function (value) {
            if (!value) return;
            helpers.setSubText(this.xml, NS, sub, value.toISOString());
        }
    };
};
...
exports.dateSubAttribute = function (NS, sub, attr, now) {
    return {
        ...
        set: function (value) {
            if (!value) return;
            helpers.setSubAttribute(this.xml, NS, sub, attr, value.toISOString());
        }
    };
};
